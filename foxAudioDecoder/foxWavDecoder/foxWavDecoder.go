...
// Byte Converter
func (FD *FoxWavDecoder) ConvertBytesToFloat64(myBytes []byte) ([][]float64, error) {
...
func (FD *FoxWavDecoder) DecodeInput(DecodedSamplesChannel chan [][]float64) error {
...
func (fd *FoxWavDecoder) DecodeWavHeader() error {
...
func (myDecoder *FoxWavDecoder) debug(message string) {
